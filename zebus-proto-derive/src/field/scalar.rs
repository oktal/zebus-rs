...
impl Field {
    ...
    pub fn encode(&self, ident: TokenStream) -> TokenStream {
        ...
        let encode_fn = quote!(::zebus_proto::encoding::#module::#encode_fn);
        let tag = self.tag;
    ...
    pub fn merge(&self, ident: TokenStream) -> TokenStream {
        ...
        let merge_fn = quote!(::zebus_proto::encoding::#module::#merge_fn);
    ...
    pub fn encoded_len(&self, ident: TokenStream) -> TokenStream {
        ...
        let encoded_len_fn = quote!(::zebus_proto::encoding::#module::#encoded_len_fn);
        let tag = self.tag;
    ...
    pub fn default(&self) -> TokenStream {
        match self.kind {
            ...
            Kind::Repeated | Kind::Packed => quote!(::zebus_proto::alloc::vec::Vec::new()),
        }
    }
    ...
    pub fn debug(&self, wrapper_name: TokenStream) -> TokenStream {
        ...
        match self.kind {
            ...
            Kind::Repeated | Kind::Packed => {
                quote! {
                    struct #wrapper_name<'a>(&'a ::zebus_proto::alloc::vec::Vec<#inner_ty>);
                    impl<'a> ::core::fmt::Debug for #wrapper_name<'a> {
                        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
...
impl BytesTy {
    ...
    fn rust_type(&self) -> TokenStream {
        match self {
            BytesTy::Vec => quote! { ::zebus_proto::alloc::vec::Vec<u8> },
            BytesTy::Bytes => quote! { ::zebus_proto::bytes::Bytes },
        }
    }
}
...
impl Ty {
    ...
    pub fn rust_type(&self) -> TokenStream {
        match self {
            Ty::String => quote!(::zebus_proto::alloc::string::String),
    ...
    pub fn owned(&self) -> TokenStream {
        match *self {
            DefaultValue::String(ref value) if value.is_empty() => {
                quote!(::zebus_proto::alloc::string::String::new())
            }
